...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Profil Instruktur</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Perbarui Kata Sandi</li>
                </ol>
            </nav>
        </div>
                    ...
                    <div class="card">
                        ...
                        <form method="post"  action="{{route('instructor.passwordSetting')}}">
                            ...
                            @endif
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Kata Sandi Saat Ini</h6>
                                    </div>
