            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Perbarui Kursus</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="card-body p-4">
                    ...
                    <div style="display: flex; align-items:center; justify-content:space-between">
                        <h5 class="mb-4">Perbarui Kursus</h5>
                    ...
                    <form class="row g-3" method="post" action="{{ route('instructor.course.update', $course->id) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="label" id="label"
                                ...
                                <option value="beginer" {{ $course->label == 'beginer' ? 'selected' : '' }}>Pemula
                                </option>
                                <option value="medium" {{ $course->label == 'medium' ? 'selected' : '' }}>Sedang</option>
                                <option value="advance" {{ $course->label == 'advance' ? 'selected' : '' }}>Profesional
                                </option>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="certificate" id="certificate"
                                ...
                                <option value="yes" {{ $course->certificate == 'yes' ? 'selected' : '' }}>Yaa</option>
                                <option value="no" {{ $course->certificate == 'no' ? 'selected' : '' }}>Tidak</option>
                        ...
                        <div class="d-flex align-items-center gap-3 mt-3">
                            ...
                            <div class="form-check form-check-warning">
                                ...
                                <label class="form-check-label" for="flexCheckWarning">Paling unggul</label>
                            </div>
                        </div>
