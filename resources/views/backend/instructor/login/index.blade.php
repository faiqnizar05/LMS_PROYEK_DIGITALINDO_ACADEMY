...
<head>
    ...
    <title>LMS - Instruktur Login Kredensial</title>
</head>
                            ...
                            <div class="card-body p-sm-5">
                                <div class="">
                                    <div class="mb-3 text-center">
                                        <img src="{{asset('backend/assets/images/logo_daa.png')}}" width="60" alt="">
                                    </div>
                                    <div class="text-center mb-4">
                                        <h5 class="">Instruktur</h5>
                                            ...
                                            <div class="col-12">
                                                <div class="text-center ">
                                                    <p class="mb-0">Belum punya akun? <a
                                                            href="authentication-signup.html">Daftar di sini</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </form>
