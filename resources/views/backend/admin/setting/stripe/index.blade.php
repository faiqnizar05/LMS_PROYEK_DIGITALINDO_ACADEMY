            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Pengaturan Stripe</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="card-body p-4">
                    ...
                    <div style="display: flex; align-items:center; justify-content:space-between">
                        <h5 class="mb-4">Konfigurasikan Stripe (Gerbang Pembayaran)</h5>
                    ...
                    <form class="row g-3" method="post" action="{{ route('admin.stripe.settings.update') }}">
                        ...
                        <div class="col-md-12">
                            <label for="publish_key" class="form-label">Kunci yang Dapat Dipublikasikan</label>
                        ...
                        <div class="col-md-12">
                            <label for="secret_key" class="form-label">Kunci Rahasia</label>
