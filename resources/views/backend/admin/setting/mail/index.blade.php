            ...
            <div class="card-body">
                ...
                <div class="card-body p-4">
                    ...
                    <div style="display: flex; align-items:center; justify-content:space-between">
                        <h5 class="mb-4">Konfigurasikan SMTP (Surel)</h5>
                    ...
                    <form class="row g-3" method="post" action="{{ route('admin.mail.settings.update') }}">
                     ...
                     @endif
                        ...
                        <div class="col-md-6">
                            <label for="port" class="form-label">Port Surat</label>
                        ...
                        <div class="col-md-6">
                            <label for="password" class="form-label">Kata Sandi Email</label>
                            <input type="password" class="form-control" name="password" id="password"
                                placeholder="Enter the mail password"  value="{{ old('password', $mailSettings->password ?? '') }}" >
                        </div>
                        <div class="col-md-6">
                            <label for="encryption" class="form-label">Enkripsi EMAIL</label>
                        ...
                        <div class="col-md-12">
                            <label for="from_address" class="form-label">ALAMAT PENGIRIM SUREL</label>
