            ...
            <div class="card-body">
                ...
                <div class="card-body p-4">
                    ...
                    <div style="display: flex; align-items:center; justify-content:space-between">
                        <h5 class="mb-4">Tambah Banner</h5>
                    ...
                    <form class="row g-3" method="post" action="{{ route('admin.slider.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <label for="slider_title" class="form-label">Judul Banner</label>
                        ...
                        <div class="col-md-12">
                            <label for="image" class="form-label">Gambar Latar Belakang</label>
                        ...
                        <div class="col-md-12">
                            <div class="d-md-flex d-grid align-items-center gap-3">
                                <button type="submit" class="btn btn-primary px-4 w-100">Buat Banner</button>
                            </div>
                        </div>
                    </form>
