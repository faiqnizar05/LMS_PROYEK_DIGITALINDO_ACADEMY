        ...
        <div class="row">
            <div class="col-lg-7 mx-auto">
                <div class="card card-item">
                    <div class="card-body">
                        <h3 class="card-title text-center fs-24 lh-35 pb-4">Masuk ke Akun Anda!</h3>
                        ...
                        <form method="post" class="pt-4" action="{{route('login')}}">
                            ...
                            <div class="input-box">
                                <label class="label-text">Email atau Nama Pengguna</label>
                            ...
                            <div class="btn-box">
                                <div class="d-flex align-items-center justify-content-between pb-4">
                                    <div class="custom-control custom-checkbox fs-15">
                                        ...
                                        <label class="custom-control-label custom--control-label" for="rememberMeCheckbox">Ingat Saya</label>
                                    </div><!-- end custom-control -->
                                    <a href="/forgot-password" class="btn-text">Lupa kata sandi saya?</a>
                                </div>
                                <button class="btn theme-btn" type="submit">Login Akun <i class="la la-arrow-right icon ml-1"></i></button>
                                <p class="fs-14 pt-2">Belum punya akun? <a href="{{route('register')}}" class="text-color hover-underline">Register</a></p>
                            </div><!-- end btn-box -->
                        </form>
                    </div><!-- end card-body -->
                </div><!-- end card -->
