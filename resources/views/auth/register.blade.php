            ...
            <div class="row">
                <div class="col-lg-7 mx-auto">
                    <div class="card card-item">
                        <div class="card-body">
                            <h3 class="card-title text-center fs-24 lh-35 pb-4">Buat Akun dan <br> Mulai Belajar!</h3>
                            ...
                            <form method="post" class="pt-4" action="{{route('register')}}">
                                ...
                                <div class="btn-box">
                                    ...
                                    <div class="custom-control custom-checkbox mb-4 fs-15">
                                        ...
                                        <label class="custom-control-label custom--control-label" for="agreeCheckbox">dengan mendaftar, saya setuju dengan
                                            <a href="terms-and-conditions.html" class="text-color hover-underline">syarat dan ketentuan</a> dan
                                            <a href="privacy-policy.html" class="text-color hover-underline">privasi
                                                kebijakan</a>
                                        </label>
                                    </div><!-- end custom-control -->
                                    <button class="btn theme-btn" type="submit">Daftarkan Akun <i
                                            class="la la-arrow-right icon ml-1"></i></button>
                                    <p class="fs-14 pt-2">Sudah punya akun? <a href="login.html"
