                    ...
                    <div class="header-widget">
                        <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14">
                            <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray">
                                ...
                                <a href="tel:081319822025" class="phone-link">081319822025</a>
                            </li>
                            <li class="d-flex align-items-center"><i class="la la-envelope-o mr-1"></i><a
                                    href="digitalindoacademy@gmail.com"> digitalindoacademy@gmail.com</a></li>
                        </ul>
                    ...
                    <div class="col-lg-2">
                        <div class="logo-box">
                            <a href="{{ route('frontend.home') }}" class="logo"><img
                                    src="{{asset('frontend/images/logo_daa.png')}}" alt="logo"
                                    style="width: 100px;"></a>
                    ...
                    <div class="col-lg-10">
                        <div class="menu-wrapper">
                            <div class="menu-category">
                                <ul>
                                    <li>
                                        <a href="#">Kategori <i class="la la-angle-down fs-12"></i></a>
                                        <ul class="cat-dropdown-menu">
                                            @foreach($categories as $item)
                                            <li>
                                                <!-- Arahkan ke route all-course dengan parameter kategori -->
                                                <a href="{{ route('all-course', ['categories[]' => $item->id]) }}">
                                                    {{$item->name}} <i class="la la-angle-right"></i>
                                                </a>
                                                <ul class="sub-menu">
                                                    @foreach ($item['subcategory'] as $data)
                                                    <!-- Untuk subkategori, bisa tambahkan parameter tambahan -->
                                                    <li>
                                                        <a
                                                            href="{{ route('all-course', ['categories[]' => $item->id, 'subcategories[]' => $data->id]) }}">
                                                            {{$data->name}}
                                                        </a>
                                                    </li>
                                                    @endforeach
                                            ...
                                            @endforeach
                                            <!-- Tambahkan link ke halaman filter lengkap -->
                                            <li class="divider"></li>
                                            <li>
                                                <a href="{{ route('all-course') }}" class="text-primary">
                                                    <i class="la la-filter"></i> Semua Kategori
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                            ...
                            <!-- FORM SEARCH YANG DIUPDATE -->
                           <form action="{{ route('all-course') }}" method="get" class="search-form">
    <div class="form-group mb-0 position-relative">
        <input class="form-control form--control pl-3 pr-5" type="text" name="search"
               placeholder="Cari Disini" value="{{ request('search') }}">
        <button type="submit" class="form-btn position-absolute" style="right: 10px; top: 50%; transform: translateY(-50%); background: none; border: none; color: #6c757d;" aria-label="Search button">
            <span class="la la-search search-icon"></span>
                            ...
                            <nav class="main-menu">
                                <ul>
                                    ...
                                    <li>
                                        <a href="/all-course">Semua Kursus </a>
                                    </li>
                                    {{-- <li>
