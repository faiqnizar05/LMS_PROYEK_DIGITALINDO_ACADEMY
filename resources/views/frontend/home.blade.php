            ...
            <div class="container">
                <div class="hero-content">
                    ...
                    <div class="hero-btn-box d-flex flex-wrap align-items-center pt-1">
                        <a href="{{ route('instructor.register') }}" class="btn theme-btn mr-4 mb-4"
                            style="background-color:#fdd126; border-color:#fdd126; color:#000;">
                        ...
                        <a href="" class="btn-text video-play-btn mb-4" data-fancybox
                            ...
                            Lihat Cuplikan<i class="la la-play icon-btn ml-2"></i>
                        </a>
        ...
        <div class="row align-items-center">
            <div class="col-lg-9">
                <div class="category-content-wrap">
                    <div class="section-heading">
                        ...
                        <h2 class="section__title">Kategori Populer</h2>
            ...
            <div class="col-lg-3">
                <div class="category-btn-box text-right">
                    <a href="categories.html" class="btn theme-btn">Semua Kategori <i
                    ...
                    <div class="category-item">
                        ...
                        <div class="category-content">
                            <div class="category-inner">
                                ...
                                <a href="#" class="btn theme-btn theme-btn-sm theme-btn-white">Jelajahi<i
                                        class="la la-arrow-right icon ml-1"></i></a>
                            </div>
...
<section class="course-area pb-120px">
    <div class="container">
        <div class="section-heading text-center">
            <h5 class="ribbon ribbon-lg mb-2">Pilih kursus yang Anda inginkan</h5>
            <h2 class="section__title">Pilihan Kursus</h2>
            <span class="section-divider"></span>
        </div><!-- end section-heading -->
    ...
    <div class="card-content-wrapper bg-gray pt-50px pb-120px">
        <div class="container">
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade {{ $index == 0 ? 'show active' : '' }}" id="{{ $data->slug }}" role="tabpanel"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card card-item" data-tooltip-content="#{{ $course->course_name_slug }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <p class="card-price text-black font-weight-bold">
                                                Rp {{ number_format($course->discount_price) }} <span
                                                    class="before-price font-weight-medium">Rp
                                                    {{ number_format($course->selling_price) }}</span>
                                            </p>
            ...
            <div class="more-btn-box mt-4 text-center">
                <a href="/all-course" class="btn theme-btn">jelajahi semua kursus <i
                        class="la la-arrow-right icon ml-1"></i></a>
...
<section class="course-area pb-90px">
    <div class="course-wrapper">
        <div class="container">
            <div class="section-heading text-center">
                <h5 class="ribbon ribbon-lg mb-2">Belajar sesuai jadwalmu</h5>
                <h2 class="section__title">Siswa sedang melihat</h2>
                <span class="section-divider"></span>
            </div><!-- end section-heading -->
            <div class="course-carousel owl-action-styled owl--action-styled mt-30px">
                ...
                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <p class="card-price text-black font-weight-bold">{{number_format($item->discount_price)}}
                                <span
                                    class="before-price font-weight-medium">{{number_format($item->selling_price)}}</span>
                            </p>
        ...
        <div class="row">
            <div class="col-lg-3 responsive-column-half">
                <div class="counter-item">
                    ...
                    <p class="counter__meta">Instruktur Ahli</p>
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="counter-item">
                    ...
                    <p class="counter__meta">Pengikut Asing</p>
                </div><!-- end counter-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="counter-item">
                    ...
                    <p class="counter__meta">Mahasiswa Terdaftar</p>
                </div><!-- end counter-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="counter-item">
                    ...
                    <p class="counter__meta">Tahun Pengalaman</p>
                </div><!-- end counter-item -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->
...
<section class="cat-area pt-80px pb-80px bg-gray position-relative">
    ...
    <div class="container">
        <div class="cta-content-wrap text-center">
            <div class="section-heading">
                <h5 class="ribbon ribbon-lg mb-2">Mulai belajar online</h5>
                <h2 class="section__title fs-45 lh-55">Tingkatkan Keterampilan Anda dengan Kursus Online Terbaik
                </h2>
            </div><!-- end section-heading -->
            <div class="cat-btn-box mt-28px">
                <a href="sign-up.html" class="btn theme-btn">Mulai <i class="la la-arrow-right icon ml-1"></i></a>
            </div><!-- end cat-btn-box -->
...
<section class="testimonial-area section-padding">
    <div class="container">
        <div class="section-heading text-center">
            <h5 class="ribbon ribbon-lg mb-2">Testimoni</h5>
            <h2 class="section__title">Masukan Mahasiswa</h2>
            <span class="section-divider"></span>
        </div><!-- end section-heading -->
    </div><!-- end container -->
        ...
        <div class="testimonial-carousel owl-action-styled">
            <div class="card card-item">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Anak-anak saya dan saya SANGAT MENYUKAI Aduca! Kursus-kursusnya luar biasa dan para
                        instruktornya sangat menyenangkan serta berpengetahuan luas. Saya hanya berharap kami
            ...
            <div class="card card-item">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Tidak peduli apa yang ingin kamu pelajari, kamu akan menemukan berbagai pilihan kursus yang
                        menakjubkan di sini. Para pengajar sangat berpengetahuan sekaligus menyenangkan dan menarik.
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad blanditiis consectetur
                    </p>
                </div><!-- end card-body -->
            </div><!-- end card -->
            <div class="card card-item">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Saya benar-benar merekomendasikan situs ini kepada semua teman saya dan siapa pun yang ingin
                        belajar keterampilan nyata. Platform ini memberi Anda kesempatan untuk belajar dari para
                        ahli pada waktu yang nyaman.
                    </p>
                </div><!-- end card-body -->
            </div><!-- end card -->
            <div class="card card-item">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Terima kasih Aduca! Kamu telah menyegarkan kembali semangatku untuk belajar dan mimpiku
            ...
            <div class="card card-item">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Saya menemukan situs ini ketika saya tidak punya dana untuk membayar pendidikan perguruan
                        tinggi. Situs ini benar-benar telah menjadi penyelamat bagi saya karena sekarang saya bisa
                        menghasilkan uang dari pekerjaan lepas menggunakan keterampilan yang saya pelajari dari
                        sini.
                    </p>
                </div><!-- end card-body -->
            </div><!-- end card -->
            ...
            <div class="card card-item">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Tidak peduli apa yang ingin Anda pelajari, Anda akan menemukan berbagai pilihan kursus yang
                        luar biasa di sini. Para instruktur sangat berpengetahuan sambil tetap menyenangkan dan
                        menarik. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad blanditiis consectetur
                    </p>
                </div><!-- end card-body -->
            </div><!-- end card -->
            <div class="card card-item">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Saya benar-benar merekomendasikan situs ini kepada semua teman saya dan siapa saja yang
                        ingin mempelajari keterampilan nyata. Platform ini memberi Anda kesempatan untuk belajar
                        dari para ahli pada waktu yang nyaman.
                    </p>
                </div><!-- end card-body -->
            </div><!-- end card -->
            <div class="card card-item">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Terima kasih Aduca! Kamu telah menyegarkan kembali semangatku untuk belajar dan impianku
                        menjadi seorang web developer.
                    </p>
                </div><!-- end card-body -->
            </div><!-- end card -->
            <div class="card card-item">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Saya menemukan situs ini ketika saya tidak punya dana untuk membayar pendidikan perguruan
                        tinggi. Situs ini benar-benar telah menjadi penyelamat karena sekarang saya bisa
                        menghasilkan uang dari pekerjaan lepas menggunakan keterampilan yang saya pelajari dari
                        sini.
                    </p>
                </div><!-- end card-body -->
