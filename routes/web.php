...
Route::get('/all-course/{filters?}', [FrontendDashboardController::class, 'all_course'])->name('all-course');
...
Route::get('/category', function () {
    return view('frontend.section.category');
...
Route::post('/pesanan/submit', [PesananController::class, 'submit']);
Route::get('/admin/pesanan', [BackendOrderController::class, 'index'])->name('admin.order.index');
Route::get('/admin/pesanan/show/{id}', [BackendOrderController::class, 'show'])->name('admin.order.show');
Route::post('/review', [UlasanController::class, 'store'])->name('review.store');
